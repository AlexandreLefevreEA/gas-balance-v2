...
plant-availability vintages (`made_on` = the `asOf` snapshot date), and `coal_schema`
([0, 1000] USD/t) for the coal forward curve (`made_on` = the trading date). Used by forecast
connectors that load into the vintage-keyed `forecast_covariate` table. See ADR 0009.
"""
