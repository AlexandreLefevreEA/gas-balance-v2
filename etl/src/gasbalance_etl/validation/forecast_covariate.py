...
non-forecast schema: `temperature_schema` ([-60, 60] °C) for temperature forecasts and
`generation_schema` ([-10_000, 200_000] MW) for generation forecasts. Used by forecast
